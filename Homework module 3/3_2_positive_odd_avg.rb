...
class Calculator
  def mean_odd_positive
    ...
    while loop_index!=arr.length()+1 do
      if ((arr[loop_index-1].to_i%2==0)&&(arr[loop_index-1].to_i>0))
        sum_of_odd_positive+=arr[loop_index-1].to_i
